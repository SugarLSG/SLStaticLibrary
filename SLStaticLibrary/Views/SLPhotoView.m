...
- (void)initializeView {
    ...
    [self.btnPrev setImage:[UIImage imageNamed:[@"SLImages.bundle" stringByAppendingPathComponent:@"arrow.left.png"]] forState:UIControlStateNormal];
    ...
    [self.btnNext setImage:[UIImage imageNamed:[@"SLImages.bundle" stringByAppendingPathComponent:@"arrow.left.png"]] forState:UIControlStateNormal];
