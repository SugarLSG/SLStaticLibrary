...
- (void)initializeView {
    ...
    [self.btnPrev setImage:[UIImage imageNamed:[@"Images.bundle" stringByAppendingPathComponent:@"arrow.left.png"]] forState:UIControlStateNormal];
    ...
    [self.btnNext setImage:[UIImage imageNamed:[@"Images.bundle" stringByAppendingPathComponent:@"arrow.left.png"]] forState:UIControlStateNormal];
